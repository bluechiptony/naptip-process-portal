...
import { ReportService } from 'src/app/report/report-service.service';

@Component({
  selector: 'app-case-report-table',
  templateUrl: './case-report-table.component.html',
  styleUrls: ['./case-report-table.component.scss'],
})
export class CaseReportTableComponent implements OnInit {
  ...
  constructor(private assessments: ReportService) {}
