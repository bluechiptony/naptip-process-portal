...
@Component({
  selector: 'app-case-victim-table',
  templateUrl: './case-victim-table.component.html',
  styleUrls: ['./case-victim-table.component.scss'],
})
export class CaseVictimTableComponent implements OnInit {
  tableColumns: string[] = [
    'userCode',
    'fullName',
    'emailAddress',
  ...
  constructor(private assessments: VictimService) {}
