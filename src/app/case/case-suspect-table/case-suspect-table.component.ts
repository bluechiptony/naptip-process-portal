...
@Component({
  selector: 'app-case-suspect-table',
  templateUrl: './case-suspect-table.component.html',
  styleUrls: ['./case-suspect-table.component.scss'],
})
export class CaseSuspectTableComponent implements OnInit {
  tableColumns: string[] = [
    'userCode',
    'fullName',
    'emailAddress',
