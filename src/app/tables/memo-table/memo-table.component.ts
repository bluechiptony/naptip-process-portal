...
import { CaseService } from 'src/app/case/case-service.service';
import { MemoService } from 'src/app/memo/memo-service.service';
...
export class MemoTableComponent implements OnInit {
  ...
  constructor(private assessments: MemoService) {}
